...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene4/vue/edit")
@Api("剧情4，业务工作流修改表单代码生成接口")
public class Scene4EditVueGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;
    @Resource(name="Scene4EditVueGeneratorImpl")
    private VueGenerator vueGenerator;

    @PostMapping("/source")
    @ApiOperation("生成剧情4工作流修改表单VUE源码")
    ...
    @PostMapping("/file")
    @ApiOperation("生成剧情4工作流修改表单VUE文件")
