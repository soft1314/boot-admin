...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene1/liquibase")
@Api("剧情1，ChangeLog 代码生成接口")
public class Scene1LiquibaseChangeLogGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene1LiquibaseChangeLogGeneratorImpl")
