...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene3/vue/view")
@Api("剧情3，基本工作流查看表单代码生成接口")
public class Scene3ViewVueGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;
    @Resource(name="Scene3ViewVueGeneratorImpl")
    private VueGenerator vueGenerator;

    @PostMapping("/source")
    @ApiOperation("生成剧情3工作流查看表单VUE源码")
    ...
    @PostMapping("/file")
    @ApiOperation("生成剧情3工作流查看表单VUE文件")
