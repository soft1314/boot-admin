...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene2/vo/query")
@Api("剧情2，查询用vo 代码生成接口")
public class Scene2QueryVoGeneratorController {
    @Resource
    ...
    @Resource(name="Scene2QueryVoGeneratorImpl")
