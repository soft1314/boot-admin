...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene4/vo/complete")
@Api("剧情4，完成任务用vo 代码生成接口")
public class Scene4CompleteVoGeneratorController {
    @Resource
    ...
    @Resource(name="Scene4CompleteVoGeneratorImpl")
