...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene3/vo/complete")
@Api("剧情3，完成任务用vo 代码生成接口")
public class Scene3CompleteVoGeneratorController {
    @Resource
    ...
    @Resource(name="Scene3CompleteVoGeneratorImpl")
