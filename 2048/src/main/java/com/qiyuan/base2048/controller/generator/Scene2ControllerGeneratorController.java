...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene2/controller")
@Api("剧情2，controller 代码生成接口")
public class Scene2ControllerGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene2ControllerGeneratorImpl")
