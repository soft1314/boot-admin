...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene2/js/api")
@Api("剧情2，单表树形查询、增加、修改、删除等功能 js api 代码生成接口")
public class Scene2JsApiGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;
    @Resource(name="Scene2JsApiGeneratorImpl")
    private JsApiGenerator jsApiGenerator;

    @PostMapping("/source")
    @ApiOperation("生成剧情2树状单表的基本操作APIJS源码")
    ...
    @PostMapping("/file")
    @ApiOperation("生成剧情2树状单表的基本操作APIJS文件")
