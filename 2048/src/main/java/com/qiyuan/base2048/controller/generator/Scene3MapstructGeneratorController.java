...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene3/mapstruct")
@Api("剧情3，matstruct 代码生成接口")
public class Scene3MapstructGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;
    @Resource(name="Scene3MapstructGeneratorImpl")
