...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene2/vo/data/resp")
@Api("剧情2，vo 代码生成接口")
public class Scene2DataVoRespGeneratorController {
    @Resource
    ...
    @Resource(name="Scene2DataRespVoGeneratorImpl")
