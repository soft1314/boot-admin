...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene2/liquibase")
@Api("剧情2，ChangeLog 代码生成接口")
public class Scene2LiquibaseChangeLogGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene2LiquibaseChangeLogGeneratorImpl")
