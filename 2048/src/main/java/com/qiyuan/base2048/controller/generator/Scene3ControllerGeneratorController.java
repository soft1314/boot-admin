...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene3/controller")
@Api("剧情3，controller 代码生成接口")
public class Scene3ControllerGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene3ControllerGeneratorImpl")
