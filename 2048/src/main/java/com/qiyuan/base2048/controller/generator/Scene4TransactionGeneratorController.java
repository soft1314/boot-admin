...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene4/transaction")
@Api("剧情4，全局事务 代码生成接口")
public class Scene4TransactionGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene4TransactionGeneratorImpl")
