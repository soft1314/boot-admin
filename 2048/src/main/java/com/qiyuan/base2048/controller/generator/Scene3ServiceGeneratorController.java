...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene3/service")
@Api("剧情3，Service 代码生成接口")
public class Scene3ServiceGeneratorController {
    @Resource
    ...
    @Resource(name="Scene3ServiceGeneratorImpl")
    private ServiceGenerator serviceGenerator;

    @PostMapping("/source")
    @ApiOperation("生成对Service源码")
