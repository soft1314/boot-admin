...
@Slf4j
@RequestMapping("/api/system/auth/generator/scene4/liquibase")
@Api("剧情1，ChangeLog 代码生成接口")
public class Scene4LiquibaseChangeLogGeneratorController {
    @Resource
    private FormValidator formValidator;
    @Resource
    private ProjectGetter projectGetter;

    @Resource(name="Scene4LiquibaseChangeLogGeneratorImpl")
