...
@Service("Scene2VueRouterGeneratorImpl")
public class Scene2VueRouterGeneratorImpl implements VueRouterGenerator {
    @Autowired
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        String src = freeMarkerUtils.generateSource(root, "scene2Router.ftl");
