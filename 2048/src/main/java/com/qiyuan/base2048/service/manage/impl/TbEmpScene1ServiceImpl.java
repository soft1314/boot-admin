...
import com.qiyuan.base2048.mapper.mapstruct.TbEmpScene1StructMapper;
...
public class TbEmpScene1ServiceImpl extends ServiceImpl<TbEmpMapper, TbEmp>  implements ITbEmpScene1Service {
  @Override
  public ResultDTO getPage(TbEmpScene1QueryVO queryVO, boolean includeDeleted) throws Exception {
    QueryWrapper<TbEmp> wrapper = new QueryWrapper();
    if(!includeDeleted) {
    ...
    IPage<TbEmp> page = new Page<>(queryVO.getCurrentPage(),queryVO.getPageSize());
    page = this.page(page,wrapper);
    return ResultDTO.success(page);
  }
  @Override
  public ResultDTO insertOrUpdate(TbEmpScene1DataVO dataVO, BaseUser baseUser) throws Exception {
    boolean result;
    TbEmp entity = TbEmpScene1StructMapper.INSTANCE.toTbEmp(dataVO);
  ...
  public ResultDTO delete(String guid) throws Exception {
    UpdateWrapper<TbEmp> updateWrapper = new UpdateWrapper();
  ...
  private TbEmp setInitialValueWhenInsert(TbEmp entity, BaseUser baseUser) throws Exception{
