...
@Service("Scene4VueRouterGeneratorImpl")
public class Scene4VueRouterGeneratorImpl implements VueRouterGenerator {
    @Autowired
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        String src = freeMarkerUtils.generateSource(root, "scene4Router.ftl");
