...
@Service("Scene3ViewVueGeneratorImpl")
public class Scene3ViewVueGeneratorImpl implements VueGenerator {
    @Resource
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        String source = freeMarkerUtils.generateSource(root, "scene3ViewVue.ftl");
        ...
        sourceCodeVO.setFileName(filePath+File.separator+humpTableName+"Scene3View.vue");
    ...
    public ResultDTO generateFile(String tableName, boolean overwrite ,TgProject tgProject) throws Exception {
        ...
        String humpTableName = StringTool.lineToHump(tableName);
        if(!overwrite) {
            if (isJsFileAlreadyExist(humpTableName+"Scene3View.vue",filePath)) {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", marker);
        freeMarkerUtils.generate(root, "scene3ViewVue.ftl", filePath, humpTableName+"Scene3View.vue");
