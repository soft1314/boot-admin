...
@Service("Scene2MapstructGeneratorImpl")
public class Scene2MapstructGeneratorImpl implements MapstructGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, boolean overwrite, TgProject tgProject) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene2Mapstruct.ftl", path, this.getFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", mapstructMarker);
        String src = freeMarkerUtils.generateSource(root, "scene2Mapstruct.ftl");
    ...
    private String getClassName(String tableName){
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName))+"Scene2StructMapper";
    }
