...
@Service("Scene3ControllerGeneratorImpl")
public class Scene3ControllerGeneratorImpl implements ControllerGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, TgProject tgProject,boolean overwrite) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene3Controller.ftl", path, this.getFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", controllerMarker);
        String src = freeMarkerUtils.generateSource(root, "scene3Controller.ftl");
    ...
    private String getClassName(String tableName) {
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName)) + "Scene3Controller";
    }
