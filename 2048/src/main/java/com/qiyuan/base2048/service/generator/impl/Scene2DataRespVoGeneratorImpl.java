...
@Service("Scene2DataRespVoGeneratorImpl")
public class Scene2DataRespVoGeneratorImpl implements VoGenerator {
    ...
    public ResultDTO generateFile(String tableName, String packageUrl, String path, String author, boolean overwrite) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene2RespDataVo.ftl", path, this.getVoFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, String packageUrl, String path, String author) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("entity", entityDTO);
        String src = freeMarkerUtils.generateSource(root, "scene2RespDataVo.ftl");
    ...
    private String getVoClassName(String tableName){
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName))+"Scene2RespDataVO";
    }
