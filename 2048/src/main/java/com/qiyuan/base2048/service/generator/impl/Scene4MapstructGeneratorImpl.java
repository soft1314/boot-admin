...
@Service("Scene4MapstructGeneratorImpl")
public class Scene4MapstructGeneratorImpl implements MapstructGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, boolean overwrite, TgProject tgProject) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene4Mapstruct.ftl", path, this.getFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", mapstructMarker);
        String src = freeMarkerUtils.generateSource(root, "scene4Mapstruct.ftl");
    ...
    private String getClassName(String tableName){
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName))+"Scene4StructMapper";
    }
    ...
    private ResultDTO createMarker(String tableName,TgProject tgProject) throws Exception{
        ...
        mapstructMarker.setDataVoName(mapstructMarker.getEntityName()+"Scene4DataVO");
