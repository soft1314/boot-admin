...
@Service("Scene2LiquibaseChangeLogGeneratorImpl")
public class Scene2LiquibaseChangeLogGeneratorImpl implements LiquibaseChangeLogGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, TgProject tgProject) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene2Liquibase.ftl", tgProject.getChangeLogDir(), fileName);
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", liquibaseMarker);
        String src = freeMarkerUtils.generateSource(root, "scene2Liquibase.ftl");
