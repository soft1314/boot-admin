...
import com.qiyuan.base2048.mapper.mapstruct.TbLogAuthScene1StructMapper;
...
*/
@Service
public class TbLogAuthScene1ServiceImpl extends ServiceImpl<TbLogAuthMapper, TbLogAuth>  implements ITbLogAuthScene1Service {
  @Override
  public ResultDTO getPage(TbLogAuthScene1QueryVO queryVO, boolean includeDeleted) throws Exception {
    QueryWrapper<TbLogAuth> wrapper = new QueryWrapper();
    if(!includeDeleted) {
  ...
  @Override
  public ResultDTO insertOrUpdate(TbLogAuthScene1DataVO dataVO, BaseUser baseUser) throws Exception {
    boolean result;
    TbLogAuth entity = TbLogAuthScene1StructMapper.INSTANCE.toTbLogAuth(dataVO);
  ...
  public ResultDTO delete(String guid) throws Exception {
    UpdateWrapper<TbLogAuth> updateWrapper = new UpdateWrapper();
  ...
  private TbLogAuth setInitialValueWhenInsert(TbLogAuth entity, BaseUser baseUser) throws Exception{
