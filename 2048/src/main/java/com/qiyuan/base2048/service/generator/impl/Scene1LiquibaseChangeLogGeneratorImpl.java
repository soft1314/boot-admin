...
@Service("Scene1LiquibaseChangeLogGeneratorImpl")
public class Scene1LiquibaseChangeLogGeneratorImpl implements LiquibaseChangeLogGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, TgProject tgProject) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene1Liquibase.ftl", tgProject.getChangeLogDir(), fileName);
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", liquibaseMarker);
        String src = freeMarkerUtils.generateSource(root, "scene1Liquibase.ftl");
