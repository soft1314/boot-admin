...
@Service("Scene1ControllerGeneratorImpl")
public class Scene1ControllerGeneratorImpl implements ControllerGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, TgProject tgProject,boolean overwrite) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene1Controller.ftl", path, this.getFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", controllerMarker);
        String src = freeMarkerUtils.generateSource(root, "scene1Controller.ftl");
    ...
    private String getClassName(String tableName) {
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName)) + "Scene1Controller";
    }
