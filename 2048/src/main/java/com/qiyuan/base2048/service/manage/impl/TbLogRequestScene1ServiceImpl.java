...
import com.qiyuan.base2048.mapper.mapstruct.TbLogRequestScene1StructMapper;
...
*/
@Service
public class TbLogRequestScene1ServiceImpl extends ServiceImpl<TbLogRequestMapper, TbLogRequest>  implements ITbLogRequestScene1Service {
  @Override
  public ResultDTO getPage(TbLogRequestScene1QueryVO queryVO, boolean includeDeleted) throws Exception {
    QueryWrapper<TbLogRequest> wrapper = new QueryWrapper();
    if(!includeDeleted) {
    ...
    IPage<TbLogRequest> page = new Page<>(queryVO.getCurrentPage(),queryVO.getPageSize());
    page = this.page(page,wrapper);
    return ResultDTO.success(page);
  }
  @Override
  public ResultDTO insertOrUpdate(TbLogRequestScene1DataVO dataVO, BaseUser baseUser) throws Exception {
    boolean result;
    TbLogRequest entity = TbLogRequestScene1StructMapper.INSTANCE.toTbLogRequest(dataVO);
  ...
  public ResultDTO delete(String guid) throws Exception {
    UpdateWrapper<TbLogRequest> updateWrapper = new UpdateWrapper();
  ...
  private TbLogRequest setInitialValueWhenInsert(TbLogRequest entity, BaseUser baseUser) throws Exception{
