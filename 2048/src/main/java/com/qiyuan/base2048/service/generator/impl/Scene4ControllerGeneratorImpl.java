...
@Service("Scene4ControllerGeneratorImpl")
public class Scene4ControllerGeneratorImpl implements ControllerGenerator {
    @Autowired
    ...
    public ResultDTO generateFile(String tableName, TgProject tgProject,boolean overwrite) throws Exception {
        ...
        freeMarkerUtils.generate(root, "scene4Controller.ftl", path, this.getFileName(tableName));
    ...
    public ResultDTO generateCode(String tableName, TgProject tgProject) throws Exception {
        ...
        Map<String, Object> root = new HashMap<>();
        root.put("marker", controllerMarker);
        String src = freeMarkerUtils.generateSource(root, "scene4Controller.ftl");
    ...
    private String getClassName(String tableName) {
        return StringTool.toUpperCaseFirstOne(StringTool.lineToHump(tableName)) + "Scene4Controller";
    }
