...
import ${marker.mapstructPackageUrl}.${marker.entityName}Scene1StructMapper;
...
import ${marker.packageUrl}.I${marker.entityName}Scene1Service;
...
*/
@Service
public class ${marker.entityName}Scene1ServiceImpl extends ServiceImpl<${marker.entityName}Mapper, ${marker.entityName}>  implements I${marker.entityName}Scene1Service {
  @Override
  public ResultDTO getPage(${marker.entityName}Scene1QueryVO queryVO, boolean includeDeleted) throws Exception {
  ...
  @Override
  public ResultDTO insertOrUpdate(${marker.entityName}Scene1DataVO dataVO, BaseUser baseUser) throws Exception {
    boolean result;
    ${marker.entityName} entity = ${marker.entityName}Scene1StructMapper.INSTANCE.to${marker.entityName}(dataVO);
