...
function _drawFlow(flow){
  ...
  if (flow.name) {
    if(flow.waypoints.length == 2){
  	   this._drawMultilineText(flow.name, flow.waypoints[0].x, flow.waypoints[0].y, flow.waypoints[1].x-flow.waypoints[0].x, 10, "middle", "middle", 11);
    }else if(flow.waypoints.length > 2){
  	   this._drawMultilineText(flow.name, flow.waypoints[1].x, flow.waypoints[1].y, flow.waypoints[2].x-flow.waypoints[1].x, 0, "middle", "middle", 11);
    }
  }
}
