<!-- 本文件自动生成，再次生成时易被覆盖 -->
<!-- @author 虚领顶劲气沉丹田 -->
<!-- @since 2023-3-30 15:14:18 -->
<template>
    <div class="app-container background-white">
        <!-- 表数据编辑对话框区开始 -->
        <el-form ref="mainEditForm" :model="mainDataForm.data" :rules="rules" size="medium" label-width="150px">
                        <el-form-item label="标题" prop="title">
                            <el-input v-model="mainDataForm.data.title" placeholder="请输入标题" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        <el-form-item label="报销金额" prop="money">
                            <el-input v-model="mainDataForm.data.money" placeholder="请输入报销金额" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        <el-form-item label="情况说明" prop="note">
                            <el-input v-model="mainDataForm.data.note" placeholder="请输入情况说明" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        ...
                        <el-form-item label="报销人" prop="empName">
                            <el-input v-model="mainDataForm.data.empName" placeholder="请输入报销人" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        ...
                        <el-form-item label="流程定义ID" prop="processDefinitionId">
                            <el-input v-model="mainDataForm.data.processDefinitionId" placeholder="请输入流程定义ID" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        <el-form-item label="流程实例ID" prop="processInstanceId">
                            <el-input v-model="mainDataForm.data.processInstanceId" placeholder="请输入流程实例ID" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        ...
                        <el-form-item label="备注" prop="remarks">
                            <el-input v-model="mainDataForm.data.remarks" placeholder="请输入备注" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
