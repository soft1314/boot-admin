    ...
    <div class="app-container background-white">
        ...
        <el-form ref="mainEditForm" :model="mainDataForm.data" :rules="rules" size="medium" label-width="150px">
                        ...
                        <el-form-item label="请假天数" prop="days">
                            <el-input v-model="mainDataForm.data.days" placeholder="请输入请假天数" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
                        ...
                        <el-form-item label="请假人" prop="empName">
                            <el-input v-model="mainDataForm.data.empName" placeholder="请输入请假人" clearable
                                      :style="{width: '100%'}" />
                        </el-form-item>
