            ...
            <div class="demo-drawer__content">
                <el-form class="demo-form-inline" style="margin-top: 25px;margin-right: 20px;" ref="drawerForm"
                         :model="filterDrawer.formData">
                                ...
                                <el-form-item label="文件名" :label-width="filterDrawer.formLabelWidth"
                                              prop="fileName">
                                    <el-input placeholder="请输入文件名" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.fileName">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="摘要" :label-width="filterDrawer.formLabelWidth"
                                              prop="summary">
                                    <el-input placeholder="请输入摘要" size="mini" prefix-icon="el-icon-search"
        ...
        <div class="table-container" style="padding: 0;margin: 0px 0px 0px 0px;">
            <el-table v-loading="loading" :data="mainTableData" border fit style="width: 100%"
                ...
                <el-table-column type="index" label="序号" :index="indexMethod" width="70">
                            ...
                            <el-table-column prop="fileName" label="文件名" show-overflow-tooltip sortable min-width="500" align="left"></el-table-column>
                            <el-table-column prop="createTime" label="记录创建时间" show-overflow-tooltip sortable min-width="120" :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                            <el-table-column prop="modifyTime" label="记录最后修改时间" show-overflow-tooltip sortable min-width="120" :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                            <el-table-column prop="enabled" label="启用状态" show-overflow-tooltip sortable min-width="80" :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.ENABLED())"></el-table-column>
                            <el-table-column prop="deleted" label="删除状态" show-overflow-tooltip sortable min-width="80" :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.DELETED())"></el-table-column>
                            <el-table-column prop="remarks" label="备注" show-overflow-tooltip sortable min-width="80"></el-table-column>
        ...
        <el-dialog :visible.sync="mainDataForm.mainDataFormDialogVisible" width="80%" :close-on-click-modal="false"
            ...
            <el-form ref="elForm" :model="mainDataForm.editingRecord" :rules="rules" size="medium" label-width="150px">
                            <el-form-item label="文件名" prop="fileName">
                                <el-input v-model="mainDataForm.editingRecord.fileName" placeholder="请输入文件名" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            <el-form-item label="摘要" prop="summary">
                                <el-input v-model="mainDataForm.editingRecord.summary" placeholder="请输入摘要" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            <el-form-item label="记录创建者" prop="createBy">
                                <el-input v-model="mainDataForm.editingRecord.createBy" placeholder="请输入记录创建者" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            ...
                            <el-form-item label="记录最后修改者" prop="modifyBy">
                                <el-input v-model="mainDataForm.editingRecord.modifyBy" placeholder="请输入记录最后修改者" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
