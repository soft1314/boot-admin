...
<template>
  <div class="app-container" style="background-color: #FFFFFF;">
      ...
      <div class="demo-drawer__content">
        <el-form class="demo-form-inline" style="margin-top: 25px;margin-right: 20px;" ref="drawerForm"
          ...
          <el-form-item label="机构编码" :label-width="filterDrawer.formLabelWidth" prop="code">
            <el-input placeholder="请输入机构编码" size="mini" prefix-icon="el-icon-search"
              v-model="filterDrawer.formData.code">
            </el-input>
          </el-form-item>
          <el-form-item label="机构名称" :label-width="filterDrawer.formLabelWidth" prop="name">
            <el-input placeholder="请输入机构名称" size="mini" prefix-icon="el-icon-search"
              v-model="filterDrawer.formData.name">
            </el-input>
          </el-form-item>
          <el-form-item label="所属区划" :label-width="filterDrawer.formLabelWidth" prop="divCode">
            <el-cascader :props="regionCascaderProps" ref="cascaderAdminDivFilter" clearable style="width: 100%;"></el-cascader>
          </el-form-item>
    ...
    <div ref="regionContainer" class="background-gray" style="margin-top: 0px;margin-bottom: 0px;padding-top: 0px;">
      当前行政区划:<el-cascader :props="regionCascaderProps" v-model="currentRegion" style="width: 600px;" ref="cascaderAdminDiv"></el-cascader>
    </div>
    <!--功能按钮区开始-->
...
<!--      <el-table-column prop="guid" label="主键" show-overflow-tooltip sortable></el-table-column>
 -->
      <el-table-column prop="code" label="机构编码" show-overflow-tooltip sortable align="left"></el-table-column>
      <el-table-column prop="name" label="机构名称" show-overflow-tooltip sortable></el-table-column>
      <el-table-column prop="divCode" label="所属区划" show-overflow-tooltip sortable></el-table-column>
      <el-table-column prop="divName" label="所属区划名称" show-overflow-tooltip sortable></el-table-column>
    ...
    <el-dialog :visible.sync="mainDataForm.mainDataFormDialogVisible" :close-on-click-modal="false"
      ...
      <el-form ref="mainEditForm" :model="mainDataForm.editingRecord" :rules="rules" size="medium" label-width="100px">
        <el-form-item label="机构编码" prop="code">
          <el-input v-model="mainDataForm.editingRecord.code" placeholder="请输入机构编码" clearable
            :style="{width: '100%'}" />
        </el-form-item>
        <el-form-item label="机构名称" prop="name">
          <el-input v-model="mainDataForm.editingRecord.name" placeholder="请输入机构名称" clearable
            :style="{width: '100%'}" />
        </el-form-item>
