...
<template>
  <div class="app-container" style="background-color: #FFFFFF;">
    ...
    >
      <el-table-column prop="admDivCode" label="行政区划代码" show-overflow-tooltip sortable align="left" />
      <el-table-column prop="admDivName" label="行政区划名称" show-overflow-tooltip sortable align="left" />
      <el-table-column
        prop="enabled"
        label="启用状态"
      ...
      <el-table-column prop="remarks" label="备注" show-overflow-tooltip width="50" />
    ...
    >
      <el-form ref="mainEditForm" :model="mainDataForm.editingRecord" :rules="rules" size="medium" label-width="150px">
        ...
        <el-form-item label="行政区划名称" prop="admDivName">
          <el-input
            v-model="mainDataForm.editingRecord.admDivName"
            placeholder="请输入行政区划名称"
            clearable
            :style="{width: '100%'}"
          />
