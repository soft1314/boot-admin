  ...
  <div class="app-container background-white">
    ...
    <div class="table-container" style="padding: 0;margin: 0px 0px 0px 0px;">
      <el-table v-loading="loading" :data="mainTableData" border fit style="width: 100%" max-height="500">
        ...
        <el-table-column prop="deleted" label="删除状态" show-overflow-tooltip sortable
        ...
        <el-table-column align="center" label="操作" show-overflow-tooltip min-width="180">
          <template slot-scope="scope">
            ...
            <el-button size="least" type="primary" @click="handlePowerButton(scope.row)">权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handlePowerButton(row){
        this.$nextTick(() => {
          this.$refs.powerComponent.showDialog()
          this.$refs.powerComponent.setComponentData(row.guid, row.code, row.name)
        })
      },
    }
  }
