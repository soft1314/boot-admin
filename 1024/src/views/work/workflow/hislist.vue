  ...
  <div class="app-container background-white">
      ...
      <div class="demo-drawer__content">
        <el-form class="demo-form-inline" style="margin-top: 25px;margin-right: 20px;" ref="drawerForm"
          ...
          <el-form-item label="办结时间" :label-width="filterDrawer.formLabelWidth" prop="taskCompleted">
            <el-date-picker v-model="filterDrawer.formData.taskCompleted" type="daterange" align="right" unlink-panels
              range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions">
            </el-date-picker>
          </el-form-item>
    ...
    <div class="table-container" style="padding: 0;margin: 0px 0px 0px 0px;">
      <el-table v-loading="loading" :data="mainTableData" border fit style="width: 100%" max-height="500">
        ...
        <el-table-column prop="outcome" label="结果" show-overflow-tooltip sortable></el-table-column>
        ...
        <el-table-column prop="endTime" label="办结时间" show-overflow-tooltip sortable
          :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async getMainTableData() {
        this.loading = false
        const response = await fetchHisPage(this.filterDrawer.formData)
        this.loading = false
