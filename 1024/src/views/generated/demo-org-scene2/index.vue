    ...
    <div class="app-container" style="background-color: #FFFFFF;">
        ...
        <el-drawer ref="drawer" :visible.sync="filterDrawer.dialogVisible" direction="rtl" custom-class="demo-drawer">
            <div class="demo-drawer__content">
                <el-form class="demo-form-inline" style="margin-top: 25px;margin-right: 20px;" ref="drawerForm" :model="filterDrawer.formData">
                                <el-form-item label="主键" :label-width="filterDrawer.formLabelWidth"
                                              prop="guid">
                                    <el-input placeholder="请输入主键" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.guid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="单位名称" :label-width="filterDrawer.formLabelWidth"
                                              prop="name">
                                    <el-input placeholder="请输入单位名称" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.name">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="社会信用代码" :label-width="filterDrawer.formLabelWidth"
                                              prop="code">
                                    <el-input placeholder="请输入社会信用代码" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.code">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="组织类别" :label-width="filterDrawer.formLabelWidth"
                                              prop="orgtype">
                                    <el-select v-model="filterDrawer.formData.orgtype" placeholder="请选择组织类别"
                                               size="mini" clearable>
                                        <el-option v-for="item in optionMap.get($commonDicType.ORGTYPE())"
                                                   :key="item.value"
                                                   :label="item.label" :value="item.value"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="行业类别" :label-width="filterDrawer.formLabelWidth" prop="industryCategory">
                                    <el-cascader :props="industryCategoryCascaderProps" ref="industryCategoryQueryCascaderId" @change="industryCategoryQueryCascaderChangeEvent" clearable style="width: 100%;">
                                    </el-cascader>
                                ...
                                <el-form-item label="单位级别" :label-width="filterDrawer.formLabelWidth"
                                              prop="rank">
                                    <el-select v-model="filterDrawer.formData.rank" placeholder="请选择单位级别"
                                               size="mini" clearable>
                                        <el-option v-for="item in optionMap.get($commonDicType.UNITLEVEL())"
                                                   :key="item.value"
                                                   :label="item.label" :value="item.value"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="编制人数" :label-width="filterDrawer.formLabelWidth"
                                              prop="num">
                                    <el-input placeholder="请输入编制人数" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.num">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="办公地址" :label-width="filterDrawer.formLabelWidth"
                                              prop="addr">
                                    <el-input placeholder="请输入办公地址" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.addr">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="负责人" :label-width="filterDrawer.formLabelWidth"
                                              prop="leader">
                                    <el-input placeholder="请输入负责人" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.leader">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="记录创建者" :label-width="filterDrawer.formLabelWidth"
                                              prop="createBy">
                                    <el-input placeholder="请输入记录创建者" size="mini" prefix-icon="el-icon-search"
                                ...
                                <el-form-item label="记录最后修改者" :label-width="filterDrawer.formLabelWidth"
                                              prop="modifyBy">
                                    <el-input placeholder="请输入记录最后修改者" size="mini" prefix-icon="el-icon-search"
                                ...
                                <el-form-item label="启用状态" :label-width="filterDrawer.formLabelWidth"
                                              prop="enabled">
                                    <el-select v-model="filterDrawer.formData.enabled" placeholder="请选择启用状态"
                                               size="mini" clearable>
                                        <el-option v-for="item in optionMap.get($commonDicType.ENABLED())"
                                                   :key="item.value"
                                                   :label="item.label" :value="item.value"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="删除状态" :label-width="filterDrawer.formLabelWidth"
                                              prop="deleted">
                                    <el-select v-model="filterDrawer.formData.deleted" placeholder="请选择删除状态"
                                               size="mini" clearable>
                                        <el-option v-for="item in optionMap.get($commonDicType.DELETED())"
                                                   :key="item.value"
                                                   :label="item.label" :value="item.value"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="备注" :label-width="filterDrawer.formLabelWidth"
                                              prop="remarks">
                                    <el-input placeholder="请输入备注" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.remarks">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="是否末级" :label-width="filterDrawer.formLabelWidth"
                                              prop="leaf">
                                    <el-select v-model="filterDrawer.formData.leaf" placeholder="请选择是否末级"
                                               size="mini" clearable>
                                        <el-option v-for="item in optionMap.get($commonDicType.YESNO())"
                                                   :key="item.value"
                                                   :label="item.label" :value="item.value"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="父级GUID" :label-width="filterDrawer.formLabelWidth"
                                              prop="parentGuid">
                                    <el-input placeholder="请输入父级GUID" size="mini" prefix-icon="el-icon-search"
                                              v-model="filterDrawer.formData.parentGuid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="顺序号" :label-width="filterDrawer.formLabelWidth"
                                              prop="sort">
                                    <el-input placeholder="请输入顺序号" size="mini" prefix-icon="el-icon-search"
        ...
        <el-table v-loading="listLoading" :data="mainTableData" stripe border highlight-current-row fit style="width: 100%"
                  ...
                  :tree-props="{hasChildren:'hasChildren'}" ref="multipleTable">
                        ...
                        <el-table-column prop="name" label="单位名称" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="code" label="社会信用代码" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="orgtype" label="组织类别" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.ORGTYPE())"></el-table-column>
                        <el-table-column prop="industryCategory" label="行业类别" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="foundTime" label="成立时间" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                        <el-table-column prop="rank" label="单位级别" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.UNITLEVEL())"></el-table-column>
                        <el-table-column prop="num" label="编制人数" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="addr" label="办公地址" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="leader" label="负责人" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="createBy" label="记录创建者" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="createTime" label="记录创建时间" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                        <el-table-column prop="modifyBy" label="记录最后修改者" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="modifyTime" label="记录最后修改时间" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                        <el-table-column prop="datestamp" label="时间戳" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                        <el-table-column prop="enabled" label="启用状态" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.ENABLED())"></el-table-column>
                        <el-table-column prop="deleted" label="删除状态" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.DELETED())"></el-table-column>
                        <el-table-column prop="remarks" label="备注" show-overflow-tooltip sortable></el-table-column>
                        <el-table-column prop="leaf" label="是否末级" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => colFormatter(row,column,cellValue, $commonDicType.YESNO())"></el-table-column>
                        <el-table-column prop="parentGuid" label="父级GUID" show-overflow-tooltip sortable></el-table-column>
        ...
        <el-dialog :visible.sync="mainDataForm.mainDataFormDialogVisible" :close-on-click-modal="false"
            ...
            <el-form ref="mainEditForm" :model="mainDataForm.editingRecord" :rules="rules" size="medium" label-width="100px">
                            <el-form-item label="单位名称" prop="name">
                                <el-input v-model="mainDataForm.editingRecord.name" placeholder="请输入单位名称" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            <el-form-item label="社会信用代码" prop="code">
                                <el-input v-model="mainDataForm.editingRecord.code" placeholder="请输入社会信用代码" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            ...
                            <el-form-item label="行业类别" prop="industryCategory">
                                <el-cascader v-model="cascaderValue.industryCategory" :props="industryCategoryCascaderProps" ref="industryCategoryEditCascaderId"
                                             style="width: 50%;" @change="industryCategoryEditCascaderChangeEvent">
                                </el-cascader>
                            ...
                            <el-form-item label="单位级别" prop="rank">
                                <el-select v-model="mainDataForm.editingRecord.rank" placeholder="请选择">
                                    <el-option
                            ...
                            <el-form-item label="编制人数" prop="num">
                                <el-input v-model="mainDataForm.editingRecord.num" placeholder="请输入编制人数" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            <el-form-item label="办公地址" prop="addr">
                                <el-input v-model="mainDataForm.editingRecord.addr" placeholder="请输入办公地址" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            <el-form-item label="负责人" prop="leader">
                                <el-input v-model="mainDataForm.editingRecord.leader" placeholder="请输入负责人" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                            ...
                            <el-form-item label="顺序号" prop="sort">
                                <el-input v-model="mainDataForm.editingRecord.sort" placeholder="请输入顺序号" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
            </el-form>
            ...
            refreshTable(parentGuid) {
                ...
                if (row) {
                    ...
                    industryCategoryLazyLoadData(node, resolve) {
                        ...
                        if(level == 0){
                            const nodes = this.loadLazyCodeNode(this.$commonDicType.INDUSTRY_CATEGORY(),'top',resolve)
                        }else{
                            const {
                                value,
                            } = node;
                            const nodes = this.loadLazyCodeNode(this.$commonDicType.INDUSTRY_CATEGORY(),value,resolve)
                        }
                    },
