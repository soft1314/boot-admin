            ...
            <div class="demo-drawer__content">
                <el-form class="demo-form-inline" style="margin-top: 25px;margin-right: 20px;" ref="drawerForm"
                         :model="filterDrawer.formData">
                                ...
                                <el-form-item label="姓名" :label-width="filterDrawer.formLabelWidth"
                                              prop="name">
                                    <el-input placeholder="请输入姓名" size="mini" prefix-icon="el-icon-search"
                                ...
                                <el-form-item label="薪水" :label-width="filterDrawer.formLabelWidth"
                                              prop="salary">
                                    <el-input placeholder="请输入薪水" size="mini" prefix-icon="el-icon-search"
        ...
        <div class="table-container" style="padding: 0;margin: 0px 0px 0px 0px;">
            <el-table v-loading="loading" :data="mainTableData" border fit style="width: 100%"
                ...
                <el-table-column type="index" label="序号" :index="indexMethod" width="70">
                            ...
                            <el-table-column prop="birthday" label="出生年月" show-overflow-tooltip sortable :formatter="(row,column,cellValue) => dateTimeColFormatter(row,column,cellValue)"></el-table-column>
                            <el-table-column prop="techTitle" label="职称" show-overflow-tooltip sortable></el-table-column>
                            <el-table-column prop="salary" label="薪水" show-overflow-tooltip sortable></el-table-column>
        ...
        <el-dialog :visible.sync="mainDataForm.mainDataFormDialogVisible" width="80%" :close-on-click-modal="false"
            ...
            <el-form ref="mainEditForm" :model="mainDataForm.editingRecord" :rules="rules" size="medium" label-width="150px">
                            <el-form-item label="姓名" prop="name">
                                <el-input v-model="mainDataForm.editingRecord.name" placeholder="请输入姓名" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
                          ...
                          <el-form-item label="职称" prop="techTitle">
                            ...
                            <el-form-item label="薪水" prop="salary">
                                <el-input v-model="mainDataForm.editingRecord.salary" placeholder="请输入薪水" clearable
                                          :style="{width: '100%'}" />
                            </el-form-item>
