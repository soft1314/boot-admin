...
@Component
public class RedisOnlineUserUtils {
    @Resource
    ...
    public static final Integer ONLINE_ACCESS_TOKEN_TIMEOUT_VALUE = 60;  //暂定10分钟，开发时60分钟吧
    /** 刷新令牌的幼年期限 秒，幼年不生产 **/
    ...
    public static final Long TOKEN_REFRESH_SAFE_TIME = 1800L; //操作令牌生成1分钟以上就需要刷新 10分钟-1分钟=9分钟=540秒，开发时1800吧
