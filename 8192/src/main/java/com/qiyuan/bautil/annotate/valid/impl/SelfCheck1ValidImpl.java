 ...
 **/
@Slf4j
public class SelfCheck1ValidImpl implements ConstraintValidator<SelfCheck1Valid, Object> {
    @Override
    public void initialize(SelfCheck1Valid selfCheck1Valid) {
    ...
    public boolean isValid(Object o, ConstraintValidatorContext constraintValidatorContext) {
        try {
            //得到方法对象
            Method checkMethod = o.getClass().getMethod("selfCheck1");
            //调用方法，得到返回值
