package com.qiyuan.workflow3072.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    private final static String FREE_PATH_PERFIX = "/api/workflow/free/**";
    private final static String AUTH_PATH_PERFIX = "/api/workflow/auth/**";
