...
@Slf4j
public class FinishFlowApprovedHandler implements ExecutionListener {
    /** 字段注入使用DEMO  **/
//    private Expression money;
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        FeignBaseService feignBaseService = GetBean.getBean(com.qiyuan.workflow3072.feign.FeignBaseService.class);
        feignBaseService.passProcess(businessTable,businessId);
        log.info("abc");
        /** 字段注入使用DEMO  **/
